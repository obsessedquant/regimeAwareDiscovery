...
OUTPUT_PARQUET = FEATURE_DIR / "feature_dataset_v3.parquet"
OUTPUT_SUMMARY = FEATURE_DIR / "feature_dataset_v3_summary.csv"
...
def main() -> None:
    ...
    print("=" * 80)
    print("Building feature_dataset_v3.parquet")
    print("=" * 80)
