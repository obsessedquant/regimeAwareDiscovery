...
OUTPUT_PARQUET = FEATURE_DIR / "feature_dataset_v4.parquet"
OUTPUT_SUMMARY = FEATURE_DIR / "feature_dataset_v4_summary.csv"
...
def main() -> None:
    ...
    print("=" * 80)
    print("Building feature_dataset_v4.parquet")
    print("=" * 80)
